...
public class MainActivity extends AppCompatActivity {
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent intent) {
        ...
        sound1 = soundPool.load(this, R.raw.goat, 1);
        sound2 = soundPool.load(this, R.raw.dog, 1);
        sound3 = soundPool.load(this, R.raw.cat, 1);
        sound4 = soundPool.load(this, R.raw.cow, 1);
        sound5 = soundPool.load(this, R.raw.horse, 1);
        sound6 = soundPool.load(this, R.raw.lion, 1);
